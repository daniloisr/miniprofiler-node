...
///////
// TODO: add try/catch to handle node version < 8
 ...
 */
 function startProfiling(request, enabled, authorized) {
  ...
  // console.log('miniprofiler ->', cls.currId);
  // Object.defineProperty(request, 'miniprofiler', {
  //   get: () => {
  //     console.log('request.miniprofiler ->', cls.getTriggerId());
  //     if (!cls.getContext()) debugger;
